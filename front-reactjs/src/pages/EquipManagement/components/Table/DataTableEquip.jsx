...
export function DataTableEquip({ columns, data }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Grid2 id="new-equipment-btn" item className="flex justify-end" style={{minWidth: "150px",}}>
          <Button
            ...
            block
            size="large"
            onClick={() => navigate("/equipamento-cadastro")}
          >
            Novo equipamento
          </Button>
        </Grid2>
